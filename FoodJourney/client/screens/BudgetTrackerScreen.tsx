...
export default function BudgetTrackerScreen() {
  ...
  const maxCategoryValue = Math.max(
    ...Object.values(summary?.categoryBreakdown || { default: 1 }),
  );
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      >
              ...
              {Object.keys(categoryIcons).map((cat) => (
                ...
                >
                  <Feather
                    ...
                    size={20}
                    color={
                      newExpense.category === cat ? "#fff" : categoryColors[cat]
                    }
                  />
                  <ThemedText
                    type="caption"
          ...
          {Object.entries(summary?.categoryBreakdown || {}).map(
            ([category, amount]) => (
              <View key={category} style={styles.chartRow}>
                ...
                <View
                  style={[styles.chartBarBg, { backgroundColor: theme.border }]}
                >
                  <View
                    style={[
                      styles.chartBar,
        ...
        <ThemedText
          type="subtitle"
          style={[styles.cardTitle, { marginTop: Spacing.xl }]}
        >
          Recent Transactions
        </ThemedText>
              ...
              <View style={styles.transactionRow}>
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        categoryColors[transaction.category] || theme.border,
                    },
                  ]}
                >
                  <Feather
                    name={
                      (categoryIcons[transaction.category] as any) || "circle"
                    }
                    size={18}
                    color="#fff"
                  />
                ...
                <ThemedText
                  type="subtitle"
                  style={{ color: theme.error || "#E76F51" }}
                >
