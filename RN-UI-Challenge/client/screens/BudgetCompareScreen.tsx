...
export default function BudgetCompareScreen() {
  ...
  const { eatOut, cookAtHome, isLoading } = useBudgetCompare(route.params.businessId);
    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <View style={styles.comparisonContainer}>
          <Card elevation={2} style={{ ...styles.optionCard, borderColor: theme.primary, borderWidth: 2 }}>
            <View style={[styles.optionHeader, { backgroundColor: theme.primary + "20" }]}>
          ...
          <Card elevation={2} style={{ ...styles.optionCard, borderColor: theme.secondary, borderWidth: 2 }}>
            <View style={[styles.optionHeader, { backgroundColor: theme.secondary + "20" }]}>
