...
const quickCategories = [
  { id: "cheap", title: "Cheap Eats", icon: "dollar-sign" as const, color: "#88AB8E" },
  { id: "study", title: "Study Cafes", icon: "book" as const, color: "#E9C46A" },
  { id: "latenight", title: "Late Night", icon: "moon" as const, color: "#F4A261" },
  { id: "grocery", title: "Groceries", icon: "shopping-cart" as const, color: "#E76F51" },
];
...
export default function StudentModeScreen() {
  ...
  const { selectedCategory, setSelectedCategory, businesses, isLoading } = useStudentMode();
    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <ThemedText type="h4" style={styles.sectionTitle}>
          {quickCategories.find(c => c.id === selectedCategory)?.title || "Recommendations"}
        </ThemedText>
