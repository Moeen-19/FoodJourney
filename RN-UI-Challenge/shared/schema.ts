...
export const users = pgTable("users", {
  ...
  city: text("city"),
  dietaryPreferences: jsonb("dietary_preferences").$type<Record<string, boolean>>(),
...
export const itineraryStopsRelations = relations(itineraryStops, ({ one }) => ({
  day: one(itineraryDays, { fields: [itineraryStops.dayId], references: [itineraryDays.id] }),
  business: one(businesses, { fields: [itineraryStops.businessId], references: [businesses.id] }),
}));
